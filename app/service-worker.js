const CACHE_NAME = "work4it-shell-v141-profile-tabs1";
...
const APP_SHELL = [
  ...
  "./modern-dashboard-ui.css?v=20260809-profile-tabs1",
  "./work4it-icons.js?v=20260722-icon-system1",
  "./modern-dashboard-ui.js?v=20260809-profile-tabs1",
  ...
  "./workit-menu-manager.js?v=20260809-profile-tabs1",
  ...
  "./auth-gate.js?v=20260809-profile-tabs1",
  "./theme-service.js?v=20260627-theme1",
  "./profile-account.js?v=20260809-profile-tabs1",
