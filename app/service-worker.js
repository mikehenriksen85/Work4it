const CACHE_NAME = "work4it-shell-v136-create-program-scroll1";
...
const APP_SHELL = [
  ...
  "./modern-dashboard-ui.css?v=20260730-create-program-scroll1",
  "./work4it-icons.js?v=20260722-icon-system1",
  "./modern-dashboard-ui.js?v=20260730-create-program-scroll1",
  ...
  "./workit-menu-manager.js?v=20260726-create-program-view1",
  ...
  "./auth-gate.js?v=20260726-create-program-view1",
